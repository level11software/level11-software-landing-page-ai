...
var colors = {
    primary: softColors.primary[button_config_1.default.appearance],
    secondary: softColors.secondary[button_config_1.default.appearance],
    accent: softColors.accent[button_config_1.default.appearance],
    danger: softColors.danger[button_config_1.default.appearance],
    success: softColors.success[button_config_1.default.appearance],
    warning: softColors.warning[button_config_1.default.appearance],
    info: softColors.info[button_config_1.default.appearance],
    gray: softColors.gray[button_config_1.default.appearance],
};
