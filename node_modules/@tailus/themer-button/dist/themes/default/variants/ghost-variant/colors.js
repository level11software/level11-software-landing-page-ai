...
var ghostColors = {
    primary: colors.primary[button_config_1.default.appearance],
    secondary: colors.secondary[button_config_1.default.appearance],
    accent: colors.accent[button_config_1.default.appearance],
    danger: colors.danger[button_config_1.default.appearance],
    success: colors.success[button_config_1.default.appearance],
    warning: colors.warning[button_config_1.default.appearance],
    info: colors.info[button_config_1.default.appearance],
    gray: colors.gray[button_config_1.default.appearance],
    neutral: colors.neutral[button_config_1.default.appearance],
};
exports.default = ghostColors;
